  ...
  return (
    <section id="overview" className="bg-white dark:bg-charcoal px-6 py-24 md:py-40 relative overflow-hidden transition-colors duration-500 border-t border-gold/10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="absolute bottom-10 left-10 pointer-events-none select-none overflow-hidden opacity-[0.03] dark:opacity-[0.05] hidden lg:block">
          <span className="text-[12rem] font-heading font-black text-gold leading-none uppercase -mb-20 block">Integrity</span>
        </div>
      </div>
    </section>
  );
